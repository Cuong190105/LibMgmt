...
//        docSample.add(new Document("Harry Potter", "J.K.Rowling", "Bloomsbury Publishing", 10, "Fantasy,Drama,Fiction", 0, false));
//        docSample.add(new Document("Doraemon", "Fujiko F. Fujio", "Shogakukan", 10, "Manga,Family,Comedy", 0, false));
//        docSample.add(new Document("Cach lam giau", "M.T.Trung", "NXB Kim Dong", 10, "Life,Drama,Book", 0, false));
//
...
//        docSample.add(new Document("Harry Style", "Eminem", "MTV", 10, "Music", 0, false));
...
//            doc.setDocID(docDAO.addDocument(doc));
//        }
//        List<Document> books = docDAO.sortedList(false);
