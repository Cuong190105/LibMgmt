...
public class AccountTest {
  ...
  public void reset() throws Exception {
    ...
    db.prepareStatement("DROP TABLE IF EXISTS account;").execute();
...
//        assertEquals("!@#$%^&*", rs.getString("hashedPassword"));
  ...
  @Test
  public void testGetAccount() throws DatabaseConnectionException {
    Account test1 = new Account(1, "Tester1", "Password1");
    accDao.addAccount(test1);
  ...
  @Test
  public void testChangePassword() throws DatabaseConnectionException {
    Account test1 = new Account(1, "Tester1", "Password1");
    accDao.addAccount(test1);
